...
uint8_t* otrcp_validate_received_data(struct otrcp *rcp, const uint8_t *buf, size_t len, uint8_t *header, uint32_t *cmd, spinel_prop_key_t *key, bool validate_cmd, bool validate_key, bool validate_tid, size_t *data_len);
